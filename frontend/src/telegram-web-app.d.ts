...
export interface WebApp {
     ...
     * smoothly follow the lower border of the window. It should not be used to
     export * pin interface elements to the bottom of the visible area. It's more
     ...
     * Note that this method can be called only in response to user interaction
     export * with the Web App interface (e.g. a click inside the Web App or on the
     * main button)
     */
     ...
     * attachment menu and only in response to a user interaction with the Web
     export * App interface (e.g. a click inside the Web App or on the main button).
     */
     ...
     * displayed. It is recommended to call this method as early as possible, as
     export * soon as all essential interface elements are loaded. Once this method is
...
/**
 export * Web Apps can adjust the appearance of the interface to match the Telegram
...
export interface BiometricManager {
     ...
     *
     * Note that this method can be called only in response to user interaction
     export * with the Mini App interface (e.g. a click inside the Mini App or on the
     * main button)
     */
...
export interface WebAppInitData {
     ...
     * of the start_param parameter will also be passed in the GET-parameter
     export * tgWebAppStartParam, so the Web App can load the correct interface right
     * away.
     */
    start_param?: string;
    /**
